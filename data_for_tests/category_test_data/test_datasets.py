...
category_create_invalid_data = [
    # Проверка создания категории с отсутствующими параметрами в конструкторе класса
    {
        'data_for_create':
            {
                'description': 'Телекоммуникации: рации, станции, смартфоны, спутниковый интернет',
        ...
        'system_answer': "Category.__init__() missing 1 required positional argument: 'name'"
    },

    {
        ...
        'system_answer': "Category.__init__() missing 1 required positional argument: 'description'"
    },

    {
        ...
        'system_answer': "Category.__init__() missing 1 required positional argument: 'products'"
    }
]

category_create_invalid_data_type = [
    {
        'data_for_create':
            {
                'name': 1,
